					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5-Search Filter and Sort Example",
									"targetURL": "#search-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"search-display": {
								...
								"action": "display",
								"description": "Example for Search a item from List, Sort and Filter",
								"title": "SAPUI5-Search Filter and Sort Example",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=search",
									"url": sap.ui.require.toUrl("search")
								}
							}
						}
					}
